...
def Y_func(t):
    global tmax
    t_control = np.array([0, 0.2*tmax, tmax])
    Y_parms = np.array([1, 1.5, 1.5])
...
simulatie_v2.simulation(X_func, Y_func, clutch_func, tmax, dt, v_s_init, n_e_init, "grafieken/exp2/")